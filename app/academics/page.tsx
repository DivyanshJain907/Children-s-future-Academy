...
export const metadata = {
  title: 'Academics - Children\'s Future Academy',
  description: 'Learn about our academic programs from Pre-Primary to Class VIII at Children\'s Future Academy.',
};
...
export default function AcademicsPage() {
  return (
    <div>
      <Hero
        title="Academics"
        subtitle="Comprehensive curriculum from Pre-Primary to Class VIII"
      />
