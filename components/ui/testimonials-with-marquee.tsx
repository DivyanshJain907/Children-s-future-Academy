      ...
      <div className="mx-auto flex max-w-container flex-col items-center gap-8 text-center sm:gap-16">
        <div className="flex flex-col items-center gap-4 px-4 sm:gap-6">
          <div className="flex flex-col items-center gap-3">
            <h2 className="max-w-[720px] text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight">
              {title}
            </h2>
            <div className="w-24 h-1 bg-accent"></div>
          </div>
          <p className="text-lg max-w-[600px] font-normal text-gray-600 sm:text-xl">
            {description}
          </p>
        </div>
